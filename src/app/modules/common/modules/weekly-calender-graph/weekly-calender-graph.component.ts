...
@Component({
  selector: 'app-weekly-calender-graph',
  templateUrl: './weekly-calender-graph.component.html',
  styleUrls: ['./weekly-calender-graph.component.scss'],
  providers: [
    {
...
export class WeeklyCalenderGraphComponent implements OnInit {
  @Output() _emitDateChanged = new EventEmitter();
  @Input() forGraph: boolean = false;
  ...
  // This will update week increment or decrement
